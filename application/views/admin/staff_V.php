                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <?php echo form_open_multipart('MStaff_C/input', 'class="form-horizontal form-material" runat="server"'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="username" placeholder="Masukkan nama" class="form-control form-control-line"> 
                                    ...
                                    <tbody>
                                        <?php $i=0; foreach($data as $item){ $i++;?>
                                            <tr>
                                                ...
                                                <td><a class="btn btn-danger" title="Hapus Data" onclick="return confirmed('<?php echo site_url('MStaff_C/delete/'.$item->id)?>')"><i class="fa fa-trash-o"></i></a></td>
